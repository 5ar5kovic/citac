...
@section('content')
    ...
    <div class="container-fluid">
        <div class="col-md-8 offset-md-2">
            <div class="d-flex align-items-center p-3 my-3 text-white-50 rounded shadow-sm bg-success">
                <div class="lh-100">
                    <h6 class="mb-0 text-white lh-100">Извештај</h6>
                </div>
            </div>
            <div class="my-3 p-3 bg-white rounded shadow-sm">
                <form action="{{ route('napravi-izvestaj') }}">
                    <div class="row">
                        ...
                        <button type="submit" class="btn btn-success"><i class="fa fa-file-excel"></i> Извештај</button>
                    </div>
                </form>
            </div>
        </div>
